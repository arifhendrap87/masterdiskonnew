...
export default function Loading(props) {
      ...
      .then(result => {
        ...
        if (urlLinking != null) {
          ...
          if (redirect === "") {
            ...
            var paramAll = { param: param };
            if (param?.paramProduct) {
              paramAll.param = param.param;
              paramAll.paramProduct = param.paramProduct;
              paramAll.product_type = param.product_type;
              paramAll.paramOriginal = param.paramOriginal;
            }


            console.log("redirect", redirect);
            console.log("paramAll", JSON.stringify(paramAll));
            navigation.navigate(redirect, paramAll);
          }
        }
  ...
  function generateConfigApi(config) {
    ...
    if (dataMasterDiskon.status == "production") {
      ...
      configApi.defPassword = dataMasterDiskon.defPassword;
