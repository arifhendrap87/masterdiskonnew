...
export default class Home extends Component {
    ...
    renderItemTopFlight(item, index) {
        ...
        //         marginRight:10,marginLeft:index == 0 ? 20 :10,
        ...
        //         height: Utils.scaleWithPixel(wp("30%")),
        //         width: "100%",
        ...
        //         <View><Text caption1>Dari Jakarta ke</Text></View>
    ...
    renderItemPromo(item, index) {
        ...
        return (
            <CardCustom
                ...
                // }
                loading={this.state.loading_dashboard}
                propOther={{ inFrame: true, horizontal: true, width: (width - 0) / 2.5 }}
                style={[
                    index == 0
                        ? { marginLeft: 20, marginRight: 10 }
                        : { marginRight: 10 }
