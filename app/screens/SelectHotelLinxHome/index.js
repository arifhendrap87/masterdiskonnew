...
export default function FlightResultVia(props) {
    ...
    var tgAwal = getDate(0);
    var tgAkhir = getDate(1);
    console.log('tgAwal', tgAwal);
    console.log('tgAkhir', tgAkhir);

    //buat ganti bulan
    var dAwal = new Date(tgAwal);
    var dAkhir = new Date(tgAkhir);
    ...
    const [tglAwal, setTglAwal] = useState(tgAwal);
    const [tglAkhir, setTglAkhir] = useState(tgAkhir);
    ...
    function onChange(select) {
        ...
        param.currentPage = 1;
        console.log('selecparamt', JSON.stringify(param));
