...
export default function SignIn(props) {
    ...
    function getPrivateToken(email, password, dataUser, type = "form") {
        ...
        fetch(url, {
            ...
            .then(result => {
                console.log('respontokenprivate', JSON.stringify(result));
    ...
    function registrasi_proses_app(dataUser) {
        ...
        fetch(url, requestOptions)
            ...
            .then((result) => {
                ...
                //getPrivateToken(dataUser.email, dataUser.password, dataUser);
    ...
    _signIn = async () => {
        ...
        try {
            ...
            getPrivateToken(userInfo.user.email, configApi.defPassword, dataUser, "google");
        } catch (error) {
    ...
    onAppleButtonPress = async () => {
        ...
        if (credentialState === appleAuth.State.AUTHORIZED) {
            ...
            getPrivateToken(email, configApi.defPassword, dataUser, "apple");
