...
export default function Pembayaran(props) {
  ...
  console.log("databookingdetail", JSON.stringify(dataBooking));
  const [bookingDoc, setBookingDoc] = useState({});
  const [dataBookingAero, setDataBookingAero] = useState({});
  const [payment, setPayment] = useState([]);
  const [modalContentType, setModalContentType] = useState("parent"); //parent,child
  ...
  const [modalVisibleBank, setModalVisibleBank] = useState(false);
  const [modalCekBayar, setModalCekBayar] = useState(false);
  ...
  const [listBankCancel, setListBankCancel] = useState([
    {
      value: "1",
      text: "Bank BRI",
    },
    ...
    {
      value: "43",
      text: "Bank BCA Syariah",
    },
  ]);
  const [selectBankCancel, setSelectBankCancel] = useState({
    value: "",
    text: "",
  });
  ...
  function durationFromText(expirydate) {
  ...
  function getPaymentMethod(total) {
    ...
    let url =
      baseUrl + "front/api_new/common/methodPayment/" + total + "/" + type;
  ...
  function content_payment() {
    ...
    //         {item.order_status.order_status_desc}
    //       </Text>
    //     </View>
    //   );
    ...
    [
      {
        ...
        icon:
          "paylater/5db129dbf7357fd4b59fe9fbbf883f74_e8dgasfl23kj4c766508e8bb827c564ccf373_compressed.png",
        fee: 0,
  ...
  function getListIndodana() {
    ...
    myHeaders.append(
      "Authorization",
      "Bearer UEFSVE5FUk1BU1RFUkRJU0tPTjEyMzEyMzEyMzEyMw=="
    );
    ...
    fetch(url, requestOptions)
      ...
      .then((result) => {
        ...
        if (result.data.payments.length != 0) {
          ...
          var item = newPayment.find(
            (item) => item.payment_type === "paylater"
          );
  ...
  //   var totalPembayaran =
  //     parseInt(order_payment_recent.iv_total_amount) + parseInt(fee);
  ...
  function tokenMidtransUpdate(param) {
    ...
    fetch(url, requestOptions)
      ...
      .catch((error) => {
        alert(
          "Kegagalan Respon Server tokenMidtransUpdate tokenMidtransUpdate"
        );
      });
  }
  ...
  function snapCharge(token) {
    ...
    myHeaders.append(
      "Authorization",
      "Basic U0ItTWlkLXNlcnZlci1rYUg3VlctakNpVjAyOGtWcmJmbjZITGY6"
    );
    myHeaders.append("Content-Type", "application/json");
    ...
    fetch(url, requestOptions)
      ...
      .catch((error) => {
        alert("Kegagalan Respon Server snapCharge");
      });
  }
  ...
  function snapTokenUpdate(paramPayMD, params) {
    ...
    fetch(url, requestOptions)
      ...
      .catch((error) => {
        alert("Kegagalan Respon Server snapTokenUpdate");
      });
  }
  ...
  function tokenMidtransUpdateCore(params) {
    ...
    console.log(
      "dataPaymenttokenMidtransUpdateCore",
    ...
    myHeaders.append(
      "Cookie",
      "__cfduid=d4ff313b0fa4bdbbb74a64dd1f5a4ccb51616649753"
    );
    ...
    return fetch(url, requestOptions)
      ...
      .catch((error) => {
        alert("Kegagalan Respon Server tokenMidtransUpdateCore");
      });
  }
  ...
  function bookingPayment(paramPayment) {
    let config = configApi;
    let baseUrl = config.apiBaseUrl;
    let url = baseUrl + "booking/payment";

    var paramnya = { product: dataOrderDetail.product, key: id_order, paymentMethod: paramPayment };
    var myHeaders = new Headers();
    myHeaders.append("Content-Type", "application/json");
    myHeaders.append("Authorization", "Bearer " + config.apiToken);

    var raw = JSON.stringify(paramnya);
    console.log("configApi", JSON.stringify(config));
    console.log("urlss", url);
    console.log("apiToken", JSON.stringify(config.apiToken));
    console.log("orderdetail", JSON.stringify(dataOrderDetail));
    console.log("paramnya", JSON.stringify(paramnya));
    ...
    fetch(url, requestOptions)
      ...
      .then((result) => {
        ...
        console.log("resultPayment", JSON.stringify(result));
  ...
  function sendReview(dataReview) {
    let config = configApi;
    let baseUrl = config.apiBaseUrl;
    let url = baseUrl + "product/review";

    var myHeaders = new Headers();
    myHeaders.append("Content-Type", "application/json");
    myHeaders.append("Authorization", "Bearer " + config.apiToken);

    var raw = JSON.stringify(dataReview);
    console.log('dataReview', raw);
    ...
    fetch(url, requestOptions)
      ...
      .then((result) => {
        ...
        console.log("resultReview", JSON.stringify(result));
  ...
  function cekStatusMidtrans(id_invoice, button) {
    ...
    myHeaders.append(
      "Authorization",
      "Basic " + config.midtransKey.authBasicHeader
    );
      ...
      .then((result) => {
        ...
        if (status_code != undefined) {
          if (status_code == "404") {
            ...
            console.log("result.transaction_status", transaction_status);

            if (transaction_status == "settlement") {
              //this.dropdown.alertWithType('success', 'Pembayaran berhasil dilakukan');
              ...
              setModalCekBayar(true);
              //alert('Menunggu pembayaran');
              //this.dropdown.alertWithType('warn', 'Menunggu pembayaran');
            }
          }
        }
  ...
  function checkHL(id_order, idInvoice) {
    ...
    fetch(url, requestOptions)
      ...
      .catch((error) => {
        alert("Kegagalan Respon Server checkHL");
      });
  }
  ...
  function showFormCancel2() {
    let config = configApi;
    let baseUrl = config.baseUrl;
    let url =
      baseUrl + "api/hotel/Hotelinx/getCheckHotelCancellationCharges/app";
    console.log("configApi", JSON.stringify(config));
    console.log("urlss", url);
  ...
  function processCancel(param) {
    let config = configApi;
    let baseUrl = config.apiBaseUrl;
    let url = baseUrl + "booking/cancel/create";
    console.log("configApi", JSON.stringify(config));
    console.log("urlss", url);
    ...
    var raw = JSON.stringify({
      ...
      customerName: pemilikRek,
      idPayment: selectBankCancel.value,
      reason: reason,
      key: id_order,
      product: "hotel",
    });
    console.log("paramCancel", raw);
    console.log("apiToken", JSON.stringify(config.apiToken));
    ...
    fetch(url, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        console.log("resultgetCancel", JSON.stringify(result));
        // var param = {
        //   id_order: id_order,
        //   dataPayment: {},
        //   back: "",
  ...
  //     }
  //   } else if (
  //     item.product == "Hotelpackage" ||
  //     item.product == "Trip" ||
  //     item.product == "Activities" ||
  //     item.product == "Hotel" ||
  ...
  function getData() {
    ...
    fetch(url, requestOptions)
      ...
      .then((result) => {
        ...
        setDataBooking(result[0]);

        // var dataBooking = result;
        // var orderStatusSlug = dataBooking[0].order_status.order_status_slug;

        // if (orderStatusSlug == "paid") {
        //   setTimeout(() => {
        //     getData();
        //   }, 1000);
        // } else {
  ...
  function getDataOrder(gotoPayment = false) {
    //setLoadingSpinner(true);
    let config = configApi;
    var baseUrl = config.apiBaseUrl;
    var url = baseUrl + "booking/detail";
    ...
    console.log("tokenss", config.apiToken);

    var myHeaders = new Headers();
    myHeaders.append("Content-Type", "application/json");
    myHeaders.append("Authorization", "Bearer " + config.apiToken);
    var raw = JSON.stringify({ key: id_order });
    ...
    fetch(url, requestOptions)
      .then((response) => response.json())
      .then((result) => {
        if (gotoPayment == false) {
          console.log("detailordergetorder", JSON.stringify(result));
          setLoadingSpinner(false);
          setDataOrderDetail(result.data);
          setTimelimit(duration(durationFromText(result.data.status.timelimit)));
        } else {
          var params = {
            title: '',
            subTitle: '',
            idOrder: id_order,
            link: 'https://app.midtrans.com/snap/v2/vtweb/' + result.data?.payments?.token
          };
  ...
  //     .catch((error) => console.log("error", error));
  // }
  console.log('dataorderdetailluar', JSON.stringify(dataOrderDetail));
  useEffect(() => {
    setLoadingSpinner(true);
  ...
  return (
    ...
    >
      ...
      <Header
        title="Pembayaran"
        //subTitle={"No.Order :" + dataBooking.codev}
        renderLeft={() => {
          return (
          ...
          <ScrollView>
            <View style={{ marginHorizontal: 20 }}>
              ...
              <PreviewBooking
                ...
                modalVisibleSub={modalVisibleSub}
                modalVisible={modalVisible}
                modalVisibleReview={modalVisibleReview}
                setModalVisible={setModalVisible}
                setModalVisibleSub={setModalVisibleSub}
                setModalVisibleCancel={setModalVisibleCancel}
                setModalVisibleReview={setModalVisibleReview}
                gotoPaymentDetailSub={gotoPaymentDetailSub}
                sendReview={sendReview}
                modalShow={modalShow}
                gotoPaymentDetail={gotoPaymentDetail}
                gotoFormPayment={gotoFormPayment}
                cekStatusMidtrans={cekStatusMidtrans}
                option={option}
                payment={payment}
                loadingPaymantMethod={loadingPaymantMethod}
                loadingButton={loadingButton}
                loadingSpinner={loadingSpinner}
                statusIndodana={statusIndodana}
                loadingIndodana={loadingIndodana}
      ...
      <View>
        ...
        >
          <View style={[styles.contentFilterBottom, { paddingBottom: 20 }]}>
            ...
            <View style={{ flexDirection: "column", marginVertical: 2 }}>
              <Text caption1>Nomor Rekeing</Text>
              <TextInput
                caption1
            ...
            <View style={{ flexDirection: "column", marginVertical: 2 }}>
              <Text caption1>Pemilik Rekeing</Text>
              <TextInput
                caption1
                style={[BaseStyle.textInput]}
                onChangeText={(text) => {
            ...
            <View style={{ flexDirection: "column", marginVertical: 2 }}>
              <Text caption1>Alasan Pembatalan</Text>
            </View>
            ...
            <View style={{ flexDirection: "row", paddingTop: 5 }}>
              ...
              >
                <Button
                  ...
                  //loading={loading}
                  onPress={() => {
                    Alert.alert("Confirm", "Yakin ingin dibatalkan ?", [
                      {
                        text: "NO",
        ...
        >
          ...
          >
            ...
            <View style={{ flexDirection: "column", marginVertical: 2 }}>
              <ScrollView>
                {listBankCancel.map((item, index) => (
                  <TouchableOpacity
                    style={styles.contentActionModalBottom}
                    key={item.value}
                    onPress={() => {
                      setModalVisibleBank(false);
                      setSelectBankCancel(item);
                    }}
                  >
                    <View
                      style={{
        ...
        <Modal
          isVisible={modalCekBayar}
          onBackdropPress={() => {
            setModalCekBayar(false);
          }}
          onSwipeComplete={() => {
            setModalCekBayar(false);
          }}
          ...
          <View style={[styles.contentFilterBottom, { paddingBottom: 50 }]}>
            ...
            <View style={{ flexDirection: "row", paddingTop: 5 }}>
              <View style={{ flex: 5, justifyContent: "center" }}>
                ...
                <Text body2>Anda belum melakukan pembayaran</Text>
              </View>
            </View>
          </View>
        </Modal>
