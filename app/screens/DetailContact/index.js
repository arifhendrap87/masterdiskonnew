...
export default class DetailContact extends Component {
    constructor(props) {
        ...
        var paramAll = {};
        if (this.props.navigation.state.params.paramAll) {
            paramAll = this.props.navigation.state.params.paramAll;
        }
    ...
    render() {
                ...
                <View style={{ flex: 4, marginRight: 15 }}>
                    ...
                    <TouchableOpacity
                        ...
                        <View style={styles.contentProfile} pointerEvents='none'>
                            ...
                            <View style={styles.searchIconSplit} onPress={() => { navigation.navigate("ProfileSmart"); }} >
        ...
        if (type == 'customer') {
            ...
            if (this.state.dataPrice.required_passport == false || typeProduct == 'trip' || typeProduct == 'hotelpackage' || typeProduct == 'activities' || typeProduct == 'hotelLinx' || typeProduct == 'hotel' || typeProduct == 'general') {
