...
export default class CardCustomArticle extends Component {
    constructor(props) {
        super(props);
        var data = props.data;
        this.state = {
    ...
    render() {
        const { navigation, title, topics, content } = this.props;
...

                {
                    ...
                    <View>
                        <View style={{ marginHorizontal: 20, paddingVertical: 0, flex: 1 }}>
                            ...
                            <HTML
                                html={'<div style="' + 'font-size:10;' + 'color:"black"' + '">' + content + '</div>'}
