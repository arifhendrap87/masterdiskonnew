    ...
    if (loading == true) {
      ...
      if (propTopDown.down != "") {
        contentDown = (
          ...
          >
            <Text footnote>{propTopDown.down}</Text>
          </View>
        );
      }
      ...
      if (propDesc1 != "") {
        contentDesc1 = (
          ...
          >
            ...
            <Text footnote style={{ textAlign: "right" }} numberOfLines={1}>
              {propDesc1}
            </Text>
          </View>
        );
          ...
          contentReview = (
            <View style={{ flexDirection: 'row', marginTop: 5 }}>
              ...
              <View style={{ flexDirection: 'column' }}>
                <Text caption1 bold style={{ marginBottom: 0 }}>{this.convertReview(parseInt(propReview))}</Text>
                <Text caption1 style={{ marginBottom: 0 }}>Review</Text>
              </View>
      ...
      if (propDesc2 != "") {
        contentDesc2 = (
          <View style={{ marginTop: 5 }}>
            <Text caption1 numberOfLines={4} style={{}}>
