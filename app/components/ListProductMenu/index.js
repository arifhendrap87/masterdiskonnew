...
export default function ListProductMenu(props) {
    ...
    // console.log('loginListProductMenu', login);
    // console.log('userSessionListProductMenu', JSON.stringify(userSession));
    // console.log('configApiListProductMenu', JSON.stringify(configApi));
