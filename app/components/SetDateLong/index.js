                            ...
                            <View style={{ marginVertical: 10 }}>
                                {
                                    this.props.type == 'flight' ?
                                        <Text body1 bold style={{ textAlign: 'center' }}>Tanggal Keberangkatan</Text>
                                        :
                                        <Text body1 bold style={{ textAlign: 'center' }}>Tanggal Checkin</Text>
                                }
                            </View>
                    ...
                    <View style={styles.contentFilterBottom}>
                        ...
                        <View style={{ flexDirection: "column" }}>
                            <View style={{ marginVertical: 10 }}>
                                {
                                    this.props.type == 'flight' ?
                                        <Text body1 bold style={{ textAlign: 'center' }}>Tanggal Kepulangan</Text>
                                        :
                                        <Text body1 bold style={{ textAlign: 'center' }}>Tanggal Checkout</Text>
                                }
                            </View>
